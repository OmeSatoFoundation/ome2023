...
「デジタル信号とアナログ信号」では、
0と1で表す信号と、0から1023までの\ruby{数値}{すう|ち}で表す信号の
\ruby{違}{ちが}いを学びます。
...
センサーは身の回りの世界の\ruby{情報}{じょう|ほう}を調べ、コンピュータに伝えるための\ruby{装置}{そう|ち}です。明るさ、温度、\ruby{湿度}{しつ|ど}を調べることができるセンサーボードは第3回の\ruby{授業}{じゅ|ぎょう}で\ruby{扱}{あつか}いました。しかし、センサーはたくさんの種類があり、出来ることももっとたくさんあります。まず、スマートフォンで使われているセンサーを見てみましょう。
\begin{figure}[htb]
\begin{center}
...
\begin{table}[htb]
  ...
  \begin{widerrows}[1.3] 
    \begin{tabular}{|l|l|} \hline
      ...
      \ruby{磁気}{じ|き}センサー & \ruby{磁力}{じ|りょく}を\ruby{検知}{けん|ち}して方角を\ruby{示}{しめ}す \\
...
このように、機械では多くのセンサーが使われています。今日の\ruby{授業}{じゅ|ぎょう}ではセンサーをいくつか\ruby{扱}{あつか}います。どのセンサーが何に使えそうか、何に使われていそうかを考えながら使ってみましょう。
...
図\ref{fig2}と図\ref{fig3}はコンピュータで使われている信号をグラフにしたものです。\ruby{授業}{じゅ|ぎょう}で使用するセンサーのデジタル信号は、図\ref{fig2}のように２種類の\ruby{値}{あたい}を表すことができます。２種類の\ruby{値}{あたい}は０か１です。一方\ruby{授業}{じゅ|ぎょう}で使用するアナログ信号は、図\ref{fig3}のように中間の\ruby{値}{あたい}を表すことができます。この\ruby{値}{あたい}は0〜1023の数字で\ruby{表現}{ひょう|げん}されます。

デジタル信号はボタンが\ruby{押}{お}されたか\ruby{押}{お}されていないか、明かりがついたか消えたかなどのふた通りのものを表すときに使われ、アナログ信号は主に明るさや\ruby{距離}{きょ|り}などの数を表すときに使われます。

\begin{tcolorbox}[title=\useOmetoi]
  \begin{enumerate}
  \addquiz{センサーとはなんだろう。説明してみましょう。}
  \addquiz{スマートフォンで使われているセンサーを3つ書いてみましょう。}
  \addquiz{アナログ信号、デジタル信号の\ruby{違}{ちが}いを書いてみましょう。}
\end{enumerate}
\end{tcolorbox}
\end{document}

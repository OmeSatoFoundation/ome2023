...
\begin{lstlisting}[caption=pwm.hsp,label=pwm.hsp]
    ...
    repeat
    gpio 27,1  <#blue#;ずっとつけている#>
    
    <#red#repeat 200#>
    <#red#if cnt < 10 : gpio 17,1 : else : gpio 17,0#>  <#blue#;200回のうち10回つけている#>
    <#red#if cnt < 50 : gpio 18,1 : else : gpio 18,0#>  <#blue#;200回のうち50回つけている#>
    <#red#if cnt < 100 : gpio 22,1 : else : gpio 22,0#>  <#blue#;200回のうち100回つけている#>
    <#red#loop#>

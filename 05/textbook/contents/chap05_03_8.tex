...
\begin{lstlisting}[caption=pwm.hsp,label=pwm.hsp]
    ...
    <#red#repeat 200
    if cnt < 10 : gpio 17,1 : else : gpio 17,0  <#blue#;200回のうち10回つけている#>
    if cnt < 50 : gpio 18,1 : else : gpio 18,0  <#blue#;200回のうち50回つけている#>
    if cnt < 100 : gpio 22,1 : else : gpio 22,0  <#blue#;200回のうち100回つけている#>
    loop#>

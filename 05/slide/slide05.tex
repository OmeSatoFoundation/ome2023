...
\begin{document}
  \subfile{contents/slide_streaming.tex}
  \subfile{contents/introduction.tex}
  \subfile{contents/sensor.tex}
  \subfile{contents/fabo.tex}
  \subfile{contents/digital_output_device.tex}
  \subfile{contents/digital_input_device.tex}
  \subfile{contents/analog_input_device.tex}
  \subfile{contents/kyori_oled.tex}
  \subfile{contents/sensor_application.tex}
  \subfile{contents/ir.tex}
  \subfile{contents/exe.tex}
\end{document}

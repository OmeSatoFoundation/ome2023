...
<#blue#02/  Bookshelf/  Documents/  Music/      Public/    Videos/#>      my.txt
\end{lstlisting}
...
\ruby{注意}{ちゅう|い}：rm はファイルを\ruby{消}{け}すコマンドです。
\ruby{講座}{こう|ざ}では、\ruby{教科書}{きょう|か|しょ}に\ruby{書}{か}かれているファイルやディレクトリ\ruby{以外}{い|がい}は\ruby{消}{け}さないでください。
わからないときは、\ruby{実行}{じっ|こう}する\ruby{前}{まえ}に\ruby{先生}{せん|せい}かTAに\ruby{見}{み}せましょう。

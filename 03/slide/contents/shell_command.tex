...
\begin{frame}
    \frametitle{今日の目標}
    \begin{itemize}
        \item 1時間目: ターミナルを使ってみよう\\
        {\footnotesize ターミナルの使い方と、ファイル・ディレクトリの考え方を学びます\\}
        \item 2時間目: ファイルを操作してみよう\\
        {\footnotesize　コマンドを使って、ファイルを表示したり、コピーしたり、移動したりする方法を学びます\\}
        \item 3時間目: センサーボードとLEDを使ってみよう\\
        {\footnotesize センサーボードを使って温度・湿度・明るさを測り、ボタンでLEDを操作するプログラムを作ります\\}
        \item 4時間目: ボタンで光るLEDを作ってみよう\\
        {\footnotesize ボタンを押すたびにLEDの状態を変えたり、光るLEDを切り替えたりするプログラムに挑戦します\\}
        \item　自習: コマンドをもっと使ってみよう\\
        {\footnotesize パイプライン、フィルタコマンド、文字の置き換え、ファイルの検索など、コマンドをもっと使ってみたい人のための内容があります。興味がある人は自分のペースで試してみましょう。\\}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item キーボードで命令を出せると、コンピュータを使いこなしている感じがするね！
    \end{itemize}
    \begin{figure}[h]
        \centering
